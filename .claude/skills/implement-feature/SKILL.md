...
- **Observe while you build.** Capture friction, planning errors, and latent bugs as they appear (implementers in task logs, you in `observations.md`); surface immediately when a current direction, blocker, or safety decision is required, otherwise preserve findings for the phase's assessed presentation; distill into `review.md` at close.
