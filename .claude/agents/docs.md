---
name: docs
description: Documentation specialist for PiCC. Use to investigate which docs a planned change touches, and to review whether a change keeps README, `doc/`, and the generated capability matrix accurate, complete, and consistent.
