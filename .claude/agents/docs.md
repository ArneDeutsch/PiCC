...
- Placement and quality: right altitude per the guide's documentation map, single-source-of-truth (link, don't copy), consistent terminology, no ephemeral cross-references, no orphaned references.
