...
const TOOL_ENTRIES: CapabilityEntry[] = [
  ...
  cap("tool", "tool.TaskStop", "partial", "stops a background subagent — cooperative via session abort; a stopped run reports a stopped status and its late result is discarded — a PiCC-defined contract (Claude Code leaves TaskStop's post-stop result semantics undocumented) (§4.3, §4.8)"),
