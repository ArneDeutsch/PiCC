...
| `doc/threat-model.md` | Agent or contributor evaluating a security concern or defense | Boundary policy | The trusted and untrusted actors, protected promises, in-scope threats, explicit exclusions, and isolation assumptions used for security decisions | Implementation mechanisms, hardening wish lists, incident history, or copies of review-process rules |
