...
| `hook.event.UserPromptSubmit` | full | fires on user prompt; stdout injected as context |
...
| `agent.frontmatter.color` | degraded-noop | parsed only — cosmetic; Pi's TUI does not render agent colors |
