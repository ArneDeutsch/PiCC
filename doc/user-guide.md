...
| Symptom | Fix |
|---|---|
| A source checkout reports a missing, stale, or damaged runtime | Run `npm run build`, exit, and relaunch; `/reload` cannot adopt the build. |
