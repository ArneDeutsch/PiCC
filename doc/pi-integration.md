...
or tool batch remains unresolved. The controller awaits that transaction plus the re-entrant
synthetic continuation before the logical run settles. Pi's configured summarization
retry policy owns retry eligibility, attempts, and
