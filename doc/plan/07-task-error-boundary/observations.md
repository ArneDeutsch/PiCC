...
- 2026-07-14 — Close review found that the test payload covered only ASCII/C0 controls and that the changelog had reintroduced generic “Unicode control” wording; a C1 `Cc` case and precise `Cc` release-note wording closed both gaps.
