...
type AuditSurface = {
  surfaceKey: string;
  page: "MCP reference" | "Settings reference" | "CLI reference" | "Hooks reference" | "Claude Code channels";
...
const EXPECTED_EVIDENCE: Readonly<Record<string, readonly AuditSurface["evidence"][number][]>> = {
  ...
  "feature.mcp-claude-json-scopes": [{"quality":"documented","source":"MCP reference — Local scope","reviewed":"2026-07-31"},{"quality":"documented","source":"MCP reference — Scope hierarchy and precedence","reviewed":"2026-07-31"},{"quality":"documented","source":"MCP reference — User scope","reviewed":"2026-07-31"},{"quality":"documented","source":"Settings reference — Environment variables","reviewed":"2026-07-31"}],
